...
import com.fastcms.payment.platform.UnionPaymentPlatform;
 ...
 * @version: 1.0
 */
public class UnionPayConfig extends UnionPayConfigStorage implements PaymentPlatformConfig {
    ...
    public UnionPayConfig httpConfigStorage(HttpConfigStorage httpConfigStorage) {
