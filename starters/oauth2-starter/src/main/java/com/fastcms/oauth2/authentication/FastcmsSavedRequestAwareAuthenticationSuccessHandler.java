...
/**
 * 扩展SavedRequestAwareAuthenticationSuccessHandler
 * 支持插件中动态设置登录成功的url
 ...
 * @version: 1.0
 */
public class FastcmsSavedRequestAwareAuthenticationSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws ServletException, IOException {
        ...
        if (loginSuccessHandler != null) {
            setDefaultTargetUrl(loginSuccessHandler.getLoginSuccessUrl(request, authentication));
        }
