...
//		String miniAppId = configService.getValue(fastcmsConstants.WECHAT_MINI_APP_ID);
//		String miniSecret = configService.getValue(fastcmsConstants.WECHAT_MINI_APP_SECRET);
