...
public class FreemarkerServlet extends HttpServlet {
     ...
     * {@link Configuration#Configuration(Version) incompatible_improvements} is 2.3.22 or higher,
...
//            params.putUnlistedModel(KEY_JSP_TAGLIBS, taglibFactory);
     ...
     *            {@link AllHttpScopesHashModel} (which is a {@link SimpleHash} subclass). Thus, you
     *            can add new variables to the data-model with the
     *            {@link SimpleHash#put(String, Object)} subclass) method. However, to adjust the
