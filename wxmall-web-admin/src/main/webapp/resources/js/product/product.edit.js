function addSpecification(){
	...
	obz.addSpecification(params, function (obj) {
		 var jobject=obj.data;
		 //for (var i = 0; i < jarr.length; i++) {
			var specificationValues=jobject.specificationValues;
			var specification=jobject.specification;
              ...
              //物流重量
                ...
                if (zuheDate.length > 0) {
                    ...
                    $.each(zuheDate, function (index, item) {
                        ...
                        td1.appendTo(tr);
                        var td2 = $("<td class=\"col-md-2\"><span class=\"requiredField\"></span><input id=\"stockId"+index+"\" name=\"stock_s\" class=\"stocks form-control\" type=\"text\" value=\"\" onkeyup=\"checkNum(this)\"><label class=\"stock_error_msg\" style=\"color:red;\"></td>");
                        td2.appendTo(tr);
                    });
                }
                //结束创建Table表
