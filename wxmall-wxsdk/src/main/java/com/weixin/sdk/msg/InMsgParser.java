...
public class InMsgParser {
	...
	private static InMsg doParse(Document doc) {
		...
		Integer createTime = Integer.parseInt(StringUtils.isBlank(XmlKit.elementText(root, "CreateTime")) ? "0" : XmlKit.elementText(root, "CreateTime"));
	...
	private static InMsg parseInEvent(Element root, String toUserName, String fromUserName, Integer createTime, String msgType) {
		...
		if ("user_get_card".equals(event)) {
			InUserGetcardEvent e = new InUserGetcardEvent(toUserName, fromUserName, createTime, msgType, event);
			e.setCardId(XmlKit.elementText(root, "CardId"));
			e.setIsGiveByFriend(XmlKit.elementText(root, "IsGiveByFriend"));
			e.setUserCardCode(XmlKit.elementText(root, "UserCardCode"));
			e.setOuterId(XmlKit.elementText(root, "OuterId"));
			return e;
		}
		if ("user_del_card".equals(event)) {
			InUserDelcardEvent e = new InUserDelcardEvent(toUserName, fromUserName, createTime, msgType, event);
			e.setCardId(XmlKit.elementText(root, "CardId"));
			e.setUserCardCode(XmlKit.elementText(root, "UserCardCode"));
			return e;
		}
		if("user_consume_card".equals(event)) {
			InUserConsumecardEvent e = new InUserConsumecardEvent(toUserName, fromUserName, createTime, msgType, eventKey);
			e.setCardId(XmlKit.elementText(root, "CardId"));
			e.setConsumeSource(XmlKit.elementText(root, "ConsumeSource"));
			e.setUserCardCode(XmlKit.elementText(root, "UserCardCode"));
			e.setLocationId(XmlKit.elementText(root, "LocationId"));
			e.setOutTradeNo(XmlKit.elementText(root, "OutTradeNo"));
			e.setStaffOpenId(XmlKit.elementText(root, "StaffOpenId"));
			e.setTransId(XmlKit.elementText(root,  "TransId"));
			return e;
		}
		if("user_pay_from_pay_cell".equals(event)){
			InUserPayfromPaycellEvent e = new InUserPayfromPaycellEvent(toUserName, fromUserName, createTime, msgType, eventKey);
			e.setCardId(XmlKit.elementText(root, "CardId"));
		...
		if("user_view_card".equals(event)){
			InUserViewcardEvent e = new InUserViewcardEvent(toUserName, fromUserName, createTime, msgType, eventKey);
			e.setCardId(XmlKit.elementText(root, "CardId"));
			e.setUserCardCode(XmlKit.elementText(root, "UserCardCode"));
			return e;
		}
		if("user_enter_session_from_card".equals(event)){
			InUserEntersessionFromcardEvent e = new InUserEntersessionFromcardEvent(toUserName, fromUserName, createTime, msgType, eventKey);
			e.setCardId(XmlKit.elementText(root, "CardId"));
			e.setUserCardCode(XmlKit.elementText(root, "UserCardCode"));
			return e;
		}
		if("update_member_card".equals(event)){
			InUpdateMembercardEvent e = new InUpdateMembercardEvent(toUserName, fromUserName, createTime, msgType, eventKey);
			e.setCardId(XmlKit.elementText(root, "CardId"));
			e.setUserCardCode(XmlKit.elementText(root, "UserCardCode"));
		...
		if("card_sku_remind".equals(event)){
			InCardskuRemindEvent e = new InCardskuRemindEvent(toUserName, fromUserName, createTime, msgType, eventKey);
			e.setCardId(XmlKit.elementText(root, "CardId"));
			e.setDetail(XmlKit.elementText(root, "Detail"));
			return e;
		}
		if("card_pay_order".equals(event)){
			InCardPayorderEvent e = new InCardPayorderEvent(toUserName, fromUserName, createTime, msgType, eventKey);
			e.setOrderId(XmlKit.elementText(root, "OrderId"));
			e.setOrderType(XmlKit.elementText(root, "OrderType"));
			e.setStatus(XmlKit.elementText(root, "status"));
			e.setPayFinishTime(XmlKit.elementText(root, "PayFinishTime"));
			e.setPayCoinCount(XmlKit.elementText(root, "PayCoinCount"));
			e.setFreeCoinCount(XmlKit.elementText(root, "FreeCoinCount"));
			e.setDesc(XmlKit.elementText(root, "Desc"));
			e.setReceiptInfo(XmlKit.elementText(root, "ReceiptInfo"));
			e.setRefundFreeCoinCount(XmlKit.elementText(root, "RefundFreeCoinCount"));
			e.setRefundPayCoinCount(XmlKit.elementText(root, "RefundPayCoinCount"));
			e.setMemo(XmlKit.elementText(root, "Memo"));
			return e;
		}
		if("submit_membercard_user_info".equals(event)){
			InSubmitMembercardUserinfoEvent e = new InSubmitMembercardUserinfoEvent(toUserName, fromUserName, createTime, msgType, eventKey);
			e.setCardId(XmlKit.elementText(root, "CardId"));
			e.setUserCardCode(XmlKit.elementText(root, "UserCardCode"));
			return e;
		}
		...
		if("weapp_audit_success".equals(event)){
			InWeappAuditSuccessEvent e = new InWeappAuditSuccessEvent(toUserName, fromUserName, createTime, msgType, eventKey);
			e.setSuccTime(XmlKit.elementText(root, "SuccTime"));
			return e;
		}
		if("weapp_audit_fail".equals(event)){
			InWeappAuditFailEvent e = new InWeappAuditFailEvent(toUserName, fromUserName, createTime, msgType, eventKey);
			e.setReason(XmlKit.elementText(root, "Reason"));
			e.setFailTime(XmlKit.elementText(root, "FailTime"));
			return e;
		}
		//小程序代码审核事件结束
