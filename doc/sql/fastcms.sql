...
INSERT INTO `permission`(`id`, `parent_id`, `name`, `path`, `component`, `title`, `icon`, `is_link`, `is_hide`, `is_keep_alive`, `is_affix`, `is_iframe`, `sort_num`, `category`, `created`, `updated`) VALUES (12, 0, 'article', '/article', 'layout/routerView/parent', 'message.router.article', 'el-icon-s-order', 0, 0, 0, 0, 0, 0, NULL, '2021-11-21 10:18:10', '2021-12-07 10:30:19');
...
INSERT INTO `permission`(`id`, `parent_id`, `name`, `path`, `component`, `title`, `icon`, `is_link`, `is_hide`, `is_keep_alive`, `is_affix`, `is_iframe`, `sort_num`, `category`, `created`, `updated`) VALUES (19, 17, 'pageAdd', '/page/write', 'page/write', 'message.router.pageAdd', 'el-icon-document-add', 0, 0, 0, 0, 0, 0, NULL, '2021-11-21 10:24:52', '2021-12-07 10:32:05');
